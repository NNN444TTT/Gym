...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-b=pzk(&)67ye131&zg&en^_xrkd7gzf9n_6ebzw)53v$_=rfj6')
...
# Use PostgreSQL if DATABASE_URL is set (Railway), otherwise SQLite locally
...
if not DEBUG:
    ...
    # When running behind a proxy (like Railway), honor the X-Forwarded-Proto header
